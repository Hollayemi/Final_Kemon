  ...
  <div class="sho">
      ...
      <?php 
          for($a=0;$a<count($allMyReadyPageArr); $a++){
            echo '<li class="mainDropper"><a class="drop" href="../pg/'.ucwords(strtolower($allMyReadyPageArr[$a])).'.php">'. $allMyReadyPageArr[$a].' </a><i class="indDrop">></i>';
            echo "<ul>";
        ...
        <ul class="nospace">
          ...
          <li class="active"><a href="../pg/<?php echo $tabb?>.php"><?php echo $tabb?></a></li>
                <?php
                    ...
                    echo '<li><a href="../pg/'.ucwords(strtolower($tabb)).'.php">'.$tabb.'</a></li>';
                  }
                }
                ?>
      ...
      <?php 
          ...
          for($a=0;$a<count($allMyReadyPageArr); $a++){
              if(strtolower($name) == strtolower($allMyReadyPageArr[$a])){
                ...
                echo '<li><a class="drop" href="../pg/'.ucwords(strtolower($allMyReadyPageArr[$a])).'.php">'. $allMyReadyPageArr[$a].'</a>';
              }
            echo "<ul>";
              for($b=0;$b<count($allMyReadyTabArr); $b++){
                $eacT = explode('-', $allMyReadyTabArr[$b]);
