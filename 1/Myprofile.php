              ...
              <div class="prof-pic">
                <div class="myAdminTop">
                  ...
                  if($myIdFetch['acc_ready'] < 1 ){
                    echo '<div class="visitWeb"><i class="fa fa-external-link"></i><a href="#">Preview</a></div>';
                  }else{
                    echo '<div class="visitWeb"><i class="fa fa-external-link"></i><a target="_blank" href="../up/'.$shop_nick.'/'.$shop_nick.'.php">Preview</a></div>';
                  }
                  ?>
              </div>        
    ...
    <section class="uploadSec main_side" id="uploadSec" style="display:none;">
      <div >
        <div class="CreateDropdown">
              <i class="fa fa-plus dropCreate"></i>
              <div class="dropee">
