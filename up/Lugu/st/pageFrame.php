...
<div class="wrapper row2">
    <div class="sectiontitle">
      <h6 class="heading" style="padding-top:50px"><?php echo $name ?></h6>
      <p></p>
    </div>
        ...
        <?php
          ...
          <button id="share" onclick="myShare('.abs($i).')" class="sharebtn"><i class="fa fa-share"></i></button>
            ...
            <form action="../st/myAction.php" method="GET">
             ...
             if (isset($id) && $visitor_id == $id){
              echo '
             <button type="submit" name="deleteNo'.abs($i).'" class="deleteProduct"><i class="fa fa-close"></i></button>
             ';
          }
             echo '</form>';
