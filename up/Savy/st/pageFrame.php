    ...
    <?php 
      ...
      for ($i=$Pict; $i >=0; $i--){
        ...
        <article style="padding-bottom:30px;">
          <figure><a href="#"><img src="../pic/'.$Mypic[abs($i)].'" style="height:200px; width:100%" alt=""></a>.
            <figcaption>
              <time datetime="2045-04-06T08:15+00:00"><strong>'.($i+1).'</strong> <em> '.$Myamt[$i].'</em></time>
            </figcaption>
          </figure>
        ...
        <?php
          ...
          <button id="share" onclick="myShare('.abs($i).')" class=" btn btn2" style="padding-top:7px;margin-top:20; height:30px !important;"><i class="fa fa-share"></i></button><br>
            ...
            <form action="../st/myAction.php" method="GET">
             <input type="text" id="cap'.abs($i).'" style="border:0px solid black;background-color:#fff; width:0px"  readonly  name="text'.abs($i).'" value="'.$Mycap[$i].'">';
             if ($myVisitor == $visitor_id){
              echo '
