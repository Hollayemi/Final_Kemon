      ...
      <div id="topbar" class="hoc clear">
          <div class="fl_left">
                    ...
                    if(isset($_SESSION['user_info_id'])){
                      $nletterUsername = $sellerInfo["username"];
                        ...
                        <form method="POST" action="'.$_SERVER["PHP_SELF"].'">
                          ...
                          echo '<li style="margin-left:90px; margin-right:30px;" class="loginNav"><a href="../../signin.php">Login</a></li>';
                        }
                        ?>
                  </li>
              </ul>
            ...
            <ul class="nospace">
              ...
              <!-- <h4 class=""><?php echo $row_id['shop_name']?></h4> -->
            </ul>
          </div>
        </div>
      </div>
    ...
    ?>
        ...
        <nav id="mainav" class="hoc clear"> 
          <ul class="clear">
            ...
            ?>
            <li class="active"><a href="../../signin.php">Logout</a></li>
          </ul>    
        </nav>
      </div>
      <?php  
