<?php
    ...
    if(!empty($row)){    
      $referralCookie= $row['agnPic'];
    }else{
      $referralCookie = "AgentPic/stephanyemmitty.png";
    }
    setcookie('referredAgn',$referralCookie, time() + 3600);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="keywords" content="kemon-market,Agent">
    
    <title>Kemon-market referral page</title>
        ...
        <header id="navbar" class="fixedOnScroll">
            <nav>
                ...
                <div class="signing-up">
                         <a class="referSignup" href="new-signup.php">Sign Up</a>
